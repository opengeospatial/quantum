= How can current quantum computers be used to solve geospatial optimization problems?
...
:keywords: ogcdoc, OGC document, OGC Discussion Paper, Quantum Computing, Optimization
:comment: ### Semicolon-delimited list of the submitting organizations; mandatory
:submitting-organizations: Helyx SIS
...
:relaton-data-source-bib1: bibtex-file.bib
...
include::sections/1-intro.adoc[]
include::sections/2-geospatial_applications.adoc[]
include::sections/3-recommendations_conclusions.adoc[]
